...
fn static_test():
    ...
    var int_literal  : IntLiteral       = 3
    var int_coef     : Int              = 3
    var int_hybrid   : IntH[1]          = IntH[1](int_coef, int_coef)

    var float_coef   : FloatLiteral     = 3
    var float_hybrid : FloatH[1]        = FloatH[1](float_coef, float_coef)
